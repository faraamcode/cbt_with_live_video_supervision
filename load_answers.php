...
<div class="question">
  ...
  <ol type="A">
   ...
   ?>
<li style="margin-top: 5px;" data-id="<?php echo $row_option['id']; ?>" class="" > <?php echo $row_option['answer']; ?> <span > <button class="btn btn-success" data-id="<?php echo $row_option['id']; ?>"  data-answer="<?php echo $row_option['answer']; ?>">Choose</button></span> </li>
<?php
